...
SQL_CONNECTION = 'postgresql://es:es-test@192.168.56.14:5432/usermanagement'
...
FACEBOOK_CALLBACK = "http://localhost:5001/facebook/callback"
...
GOOGLE_CALLBACK = "http://localhost:5001/google/callback"
